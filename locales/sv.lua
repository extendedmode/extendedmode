Locales['sv'] = {
  ...
  ['company_nomoney'] = 'företaget du är anställd hos har inte råd att betala ut din lön',
  ...
  ['weapon_sawnoffshotgun'] = 'sågad shotgun',
  ['weapon_assaultshotgun'] = 'assault shotgun',
  ['weapon_bullpupshotgun'] = 'bullpup shotgun',
  ['weapon_stungun'] = 'elpistol',
  ['weapon_sniperrifle'] = 'prickskyttegevär',
  ['weapon_heavysniper'] = 'tung prickskyttegevär',
  ...
  ['component_clip_extended'] = 'förlängt magg',
